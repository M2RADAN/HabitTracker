...
Проект в активной фазе разработки. **Этап 1 (Ядро приложения) полностью завершен!** Начата работа над **Этапом 2 (Визуализация и Мотивация)**. Реализована ключевая механика "стриков" (непрерывных серий выполнений).
